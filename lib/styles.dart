...
class Corners {
  ...
  static const double round = 32;
  static const BorderRadius roundBorder = const BorderRadius.all(lgRadius);
  static const Radius roundRadius = const Radius.circular(lg);
}
...
class TextStyles {
  ...
  static TextStyle get h1 => fraunces.copyWith(fontWeight: FontWeight.w600, fontSize: FontSizes.s48, letterSpacing: -1, height: 1.17);
  ...
  static TextStyle get callout1 => raleway.copyWith(fontWeight: FontWeight.w800, fontSize: FontSizes.s12, height: 1.17, letterSpacing: .5);
  ...
  static TextStyle get tip => callout2.copyWith(color: Colors.grey, fontWeight: FontWeight.normal);
}
