...
import 'package:penguin_stats_flutter/widget/styled_widget/app_icons.dart';

class ContextMenuIcon extends StatelessWidget {
  final AppIcons icon;
  final Color? color;

  const ContextMenuIcon({Key? key, required this.icon, this.color})
      : super(key: key);
...
class ContextMenuIconHovered extends StatelessWidget {
  const ContextMenuIconHovered({Key? key, required this.icon})
      : super(key: key);
  final AppIcons icon;
